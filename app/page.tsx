  ...
  return (
    <>
      ...
      <div className="container">
        <h2>Guia turística Barracão</h2>
        <p>
          Se você está de visita em Barracão uma das primeiras coisas a se fazer
          é encontrar algum lugar para se fixar, nesta guia te mostraremos
          algumas hospedarias e posteriormente lugares para visitar aqui na
          nossa cidade, a ordem que vamos utilizar não é por avaliações, então
