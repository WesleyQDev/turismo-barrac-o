    ...
    <>
      ...
      <div className="conteudo">
        ...
        <p>
          ...
          entre outros serviços, também possuem mais de 400 comentários no
          Google Maps com uma avaliação de 4/5.
        </p>
        <Card
          src="/hotellf"
        ...
        <p>
          ...
          ganhando inclusive um certificado de qualidade no serviço e
          atendimento a o cliente.
        </p>
        <Card
          src="/restaurante-casa-deodoros"
        ...
        <Card
          src="/gruta-de-santa-emilia-rodat"
